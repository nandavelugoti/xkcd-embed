...
Step 1: Load `xkcd-embed.js` by adding this to your html head:

```html
<script src="https://raw.githack.com/nandavelugoti/xkcd-embed/refs/heads/main/xkcd-embed.js"></script>
```

Step 2: Use it anywhere you want in the html by:
